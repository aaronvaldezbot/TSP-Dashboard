                    ...
                    <div class="portlet light">
                        <%--<div class="portlet-title">
                            ...
                            <div class="actions" hidden>
                                ...
                                <div class="modal fade bs-modal-sm" id="modalSmElegirEquipo" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <label id="nombreUsuario" hidden><asp:LoginName runat="server"/></label>
                                ...
                                <div id="ModalConfiguracionGlobal" data-backdrop="static" class="modal fade">
                                    <%--<div class="modal-dialog">--%>
                                ...
                                <div id="ModalConfigurarEquipo" class="modal fade modal-lg" role="dialog">
                        ...
                        <select class="table-group-action-input form-control input-inline input-small input-sm select2-container" id="iIdPlan" onchange="ObtenerRequerimiento();ObtenerDatosByPlan();" disabled style="width: 19%;">
                            <option></option>
                        </select>
                        ...
                        <div id="ModalHibrido" data-backdrop="static" class="modal fade">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <%--<button type="button" class="close" data-dismiss="modal">&times;</button>--%>
